...
- Modelling and simulation of turbidity currents for process
  stratigraphy.
...
- *Functional Languages* - Racket, Scheme (R5RS, R6RS), Common Lisp,
  Clojure,  Haskell (basic working knowledge only), OCaml
