...
A computational scientist and engineering developer primarily focused on algorithm and software development for the numerical solution of differential-algebraic equations, ordinary differential equations, partial differential equations, and linear and nonlinear algebraic equations pertaining to modelinging systems involved in physical and industrial processes, especially those involving fluid dynamics, coupled fluid-structure interactions and  heat transfer.
