...
on algorithm and software development for the numerical solution of
...
equations pertaining to modeling systems involved in physical and
industrial processes, especially those involving wave propagation,
fluid dynamics, coupled fluid-structure interactions and heat
transfer.
...
|---------------------------+----------------------------+--------------|
| *Andvanced HPC Developer* | High Performance Computing | 2016-present |

- Analysis and optimization of in-house seismic imaging and inversion
  software

- Development of a modeling and simulation abstraction system
  including a declarative DSL based on a comonad notation for the
  description of PDEs or stencil calculations to facilitate automated
  application of optimizations over a large variety of wave
  propagation kernels and hardware architectures.
...
- Text mining and natural language processing in support of data analytics for well stimulation effectiveness analysis.
